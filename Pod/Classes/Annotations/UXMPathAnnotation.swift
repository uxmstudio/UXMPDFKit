...
open class PDFPenAnnotation: UXMPathAnnotation, UXMPDFAnnotationButtonable {
    
    public static var name: String? { return "Pen" }
    public static var buttonImage: UIImage? { return UIImage.bundledImage("pen") }
}

open class PDFHighlighterAnnotation: UXMPathAnnotation, UXMPDFAnnotationButtonable {
