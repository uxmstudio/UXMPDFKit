...
public protocol UXMSinglePageViewerDelegate {
    ...
    func singlePageViewer(_ collectionView: UXMSinglePageViewer, selected annotation: PDFAnnotationView)
...
extension UXMSinglePageViewer: UXMPageContentViewDelegate {
    ...
    public func contentView(_ contentView: UXMPageContentView, didSelect annotation: PDFAnnotationView) {
